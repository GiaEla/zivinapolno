# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-22 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', models.CharField(max_length=30, null=True, verbose_name='kratek opis')),
                ('description', models.CharField(max_length=500, verbose_name='Opis')),
                ('date_from', models.DateField(null=True, verbose_name='Pričetek')),
                ('date_to', models.DateField(null=True, verbose_name='Zaključek')),
                ('independently_sold', models.BooleanField(default=False, verbose_name='Možen je nakup posamičnih vstopnic')),
                ('btn_type', models.CharField(default=None, max_length=50, verbose_name='Napis na gumbu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20, null=True, verbose_name='Ime')),
            ],
            options={
                'verbose_name': 'slika',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=500, verbose_name='Opis')),
                ('product_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Slika')),
